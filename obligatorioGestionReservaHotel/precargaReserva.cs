...
namespace obligatorioGestionReservaHotel
{
    public class PrecargaReserva
    {
        ...
        reservas.Add(new Reserva(huesped3, habitacio3, new DateTime(2024, 11, 01), new DateTime(2024, 11, 20)));
        reservas.Add(new Reserva(huesped4, habitacio4, new DateTime(2024, 08, 19), new DateTime(2024, 08, 22)));
        reservas.Add(new Reserva(huesped1, habitacio3, new DateTime(2024, 10, 26), new DateTime(2024, 11, 03)));
